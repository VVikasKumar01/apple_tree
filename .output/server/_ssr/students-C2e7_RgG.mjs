...
import { D as Dialog, d as DialogTrigger, a as DialogContent, b as DialogHeader, c as DialogTitle } from "./dialog-CZ3oge5o.mjs";
...
import { u as useAcademicYear, a as ACADEMIC_YEARS, C as CLASS_OPTIONS, G as GENDER_OPTIONS } from "./constants-C7cxSjft.mjs";
import { u as useAuth } from "./router-BTkK5XoE.mjs";
import { l as Upload, D as Download, n as Plus, e as Search, o as Pencil, T as Trash2, p as Copy } from "../_libs/lucide-react.mjs";
...
function StudentsPage() {
  ...
  const [form, setForm] = reactExports.useState(() => getEmptyStudent(year));
  ...
  const {
    ...
    queryFn: async () => {
      const {
        data,
        error
      } = await supabase.from("students").select("*").eq("academic_year", year).order("created_at", {
        ascending: false
      });
  ...
  const handleImport = async (file) => {
    ...
    try {
      ...
      const {
        ...
        onConflict: "school,academic_year,admission_number"
      });
      if (error) return toast.error(error.message);
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center justify-between gap-3", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Dialog, { open, onOpenChange: (o) => {
          setOpen(o);
          if (!o) setForm(getEmptyStudent(year));
        }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-3 flex flex-wrap items-center gap-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: year, onValueChange: setYear, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { className: "w-36", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: "Academic Year" }) }),
...
function StudentForm({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { title: "Identity", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-3 sm:grid-cols-3", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs", children: "Academic Year*" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: form.academic_year ?? "", onValueChange: (v) => set("academic_year", v), children: [
