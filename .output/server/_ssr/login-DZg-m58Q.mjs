...
import { u as useAuth, S as SCHOOLS } from "./router-BTkK5XoE.mjs";
...
import { a as applePlayLogo, b as appleTreeLogo } from "./apple-play-logo-CY8o4T-u.mjs";
    ...
    if (mode === "signin") {
      ...
      if (error) {
        ...
        if (authedUser) {
          const {
            data: roleData
          } = await supabase.from("user_roles").select("school").eq("user_id", authedUser.id).maybeSingle();
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex min-h-screen items-center justify-center overflow-hidden bg-background p-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "w-full max-w-md p-8 shadow-elegant", children: !school ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6 text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto mb-3 flex h-16 w-16 items-center justify-center overflow-hidden rounded-xl border bg-white shadow-elegant", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: applePlayLogo, alt: "School Management Logo", className: "h-full w-full object-contain" }) }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-3", children: SCHOOLS.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => setSchool(s.code), className: "group flex items-center gap-3 rounded-xl border bg-card p-4 text-left transition hover:border-primary/50 hover:shadow-card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-14 w-14 items-center justify-center overflow-hidden rounded-lg border bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: SCHOOL_META[s.code].logo, alt: `${s.name} logo`, className: "h-full w-full object-contain" }) }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6 flex flex-col items-center text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-3 flex h-16 w-16 items-center justify-center overflow-hidden rounded-xl border bg-white shadow-elegant", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: SCHOOL_META[school].logo, alt: "School logo", className: "h-full w-full object-contain" }) }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handle, className: "space-y-4", children: [
        ...
        mode !== "reset" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { id: "password", type: showPassword ? "text" : "password", required: true, minLength: 6, value: password, onChange: (e) => setPassword(e.target.value), placeholder: "••••••••", className: "pr-10" }),
