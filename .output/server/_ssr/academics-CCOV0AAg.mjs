...
import { D as Dialog, a as DialogContent } from "./dialog-CZ3oge5o.mjs";
import { u as useAcademicYear, C as CLASS_OPTIONS, G as GENDER_OPTIONS } from "./constants-C7cxSjft.mjs";
import { u as useAuth, s as schoolName } from "./router-BTkK5XoE.mjs";
import { t as toast } from "../_libs/sonner.mjs";
import { b as appleTreeLogo, a as applePlayLogo } from "./apple-play-logo-CY8o4T-u.mjs";
import { e as Search, l as Upload, D as Download, n as Plus, T as Trash2, u as Printer } from "../_libs/lucide-react.mjs";
...
function MarksTab({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-4 space-y-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: classFilter, onValueChange: (v) => {
        setClassFilter(v);
        setStudentId("");
      }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-4 md:grid-cols-[280px_1fr]", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-md border max-h-[420px] overflow-y-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sticky top-0 bg-muted/50 px-3 py-2 text-xs font-medium text-muted-foreground", children: [
          filteredStudents.length,
          " student",
          filteredStudents.length === 1 ? "" : "s"
        ] }),
        filteredStudents.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 text-sm text-muted-foreground", children: "No students match your filters." }) : filteredStudents.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => setStudentId(s.id), className: `block w-full border-t px-3 py-2 text-left text-sm hover:bg-muted/50 ${studentId === s.id ? "bg-primary/10 font-semibold" : ""}`, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: s.student_name }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: !studentId ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-md border p-6 text-center text-sm text-muted-foreground", children: "Select a student from the list to enter or view marks." }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4 rounded-xl border bg-muted/20 p-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
            selectedStudent?.photo_url ? /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: selectedStudent.photo_url, alt: selectedStudent.student_name, className: "h-12 w-12 rounded-lg object-cover border" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-12 w-12 shrink-0 items-center justify-center rounded-lg bg-gradient-primary text-lg font-bold text-primary-foreground shadow-sm", children: selectedStudent?.student_name?.[0] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-semibold truncate text-base", children: selectedStudent?.student_name }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3 grid gap-2 text-xs border-t pt-2 border-border sm:grid-cols-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: "Father: " }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium", children: selectedStudent?.father_name || "—" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: "Mother: " }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium", children: selectedStudent?.mother_name || "—" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: "Contact: " }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium", children: selectedStudent?.primary_mobile || "—" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: "DOB: " }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium", children: selectedStudent?.date_of_birth || "—" })
            ] })
          ] })
        ] }),
...
function AttendanceTab({
  ...
  const {
    ...
    queryFn: async () => {
      const {
        data: s
      } = await supabase.from("students").select("id,admission_number,student_name").eq("academic_year", year).eq("school", school);
      const {
        data: a
      } = await supabase.from("attendance_summary").select("*").eq("academic_year", year).eq("school", school);
...
function ReportCardTab({
  ...
  const [q, setQ] = reactExports.useState("");
  const [classFilter, setClassFilter] = reactExports.useState("all");
  const [termFilter, setTermFilter] = reactExports.useState("all");
  const {
    data: marks = []
  } = useQuery({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-4 space-y-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Search, { className: "h-4 w-4 text-muted-foreground" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { placeholder: "Search name / admission #", value: q, onChange: (e) => setQ(e.target.value), className: "max-w-xs" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: termFilter, onValueChange: (v) => setTermFilter(v), children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { className: "w-36", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, {}) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "all", children: "All terms" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "term1", children: "Term 1 only" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "term2", children: "Term 2 only" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "term3", children: "Term 3 only" })
        ] })
      ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-3 md:grid-cols-[280px_1fr]", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-md border max-h-[360px] overflow-y-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sticky top-0 bg-muted/50 px-3 py-2 text-xs text-muted-foreground", children: [
          filtered.length,
          " student",
          filtered.length === 1 ? "" : "s"
        ] }),
        filtered.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => setStudentId(s.id), className: `block w-full border-t px-3 py-2 text-left text-sm hover:bg-muted/50 ${studentId === s.id ? "bg-primary/10 font-semibold" : ""}`, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: s.student_name }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs text-muted-foreground", children: [
            s.admission_number,
            " · ",
        ...
        filtered.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 text-sm text-muted-foreground", children: "No students." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-md border p-4 text-sm", children: student ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-lg font-semibold", children: student.student_name }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-1 text-xs text-muted-foreground", children: [
          "Click ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("b", { children: "Preview / Print" }),
          " to open the report card."
        ] })
      ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-muted-foreground", children: "Select a student to preview the report card." }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open, onOpenChange: setOpen, children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogContent, { className: "max-w-3xl max-h-[90vh] overflow-y-auto p-0", children: student && /* @__PURE__ */ jsxRuntimeExports.jsx(ReportCard, { student, marks, att, year, schoolLabel: schoolName(school), schoolCode: school, termFilter }) }) })
  ] });
}
function ReportCard({
  student,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white text-black", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "report-card", className: "p-8 space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between border-b pb-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          logoUrl && /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: logoUrl, alt: schoolLabel, className: "h-16 w-16 object-contain" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full border-collapse text-sm", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { className: "bg-gray-100", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
          ...
          showT1 && /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "border p-2 text-right", children: "Term 1" }),
          showT2 && /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "border p-2 text-right", children: "Term 2" }),
          showT3 && /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "border p-2 text-right", children: "Term 3" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("tbody", { children: [
          marks.map((m) => {
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
              ...
              showT1 && /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "border p-2 text-right", children: m.term1_marks ?? "—" }),
              showT2 && /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "border p-2 text-right", children: m.term2_marks ?? "—" }),
              showT3 && /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "border p-2 text-right", children: m.term3_marks ?? "—" }),
          ...
          marks.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("td", { colSpan: 3 + termCount, className: "border p-4 text-center text-gray-500", children: "No marks recorded." }) }),
          marks.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "bg-gray-50 font-semibold", children: [
            ...
            showT1 && /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "border p-2 text-right", children: totals.term1 }),
            showT2 && /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "border p-2 text-right", children: totals.term2 }),
            showT3 && /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "border p-2 text-right", children: totals.term3 }),
