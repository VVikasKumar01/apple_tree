...
const appCss = "/assets/styles-C8j0AQ1G.css";
...
const $$splitComponentImporter$a = () => import("./login-BKFNtKv8.mjs");
const Route$a = createFileRoute("/login")({
  component: lazyRouteComponent($$splitComponentImporter$a, "component")
});
const $$splitComponentImporter$9 = () => import("../_authenticated-8gYME7H_.mjs");
const Route$9 = createFileRoute("/_authenticated")({
  component: lazyRouteComponent($$splitComponentImporter$9, "component")
});
const $$splitComponentImporter$8 = () => import("./index-yjCegsCp.mjs");
const Route$8 = createFileRoute("/")({
  component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
const $$splitComponentImporter$7 = () => import("./tuition-fees-DNR1KtGk.mjs");
const Route$7 = createFileRoute("/_authenticated/tuition-fees")({
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
const $$splitComponentImporter$6 = () => import("./students-DG_uXwbV.mjs");
...
const $$splitComponentImporter$4 = () => import("./other-fees-_eDMGpS6.mjs");
const Route$4 = createFileRoute("/_authenticated/other-fees")({
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./dashboard-D5yopo01.mjs");
const Route$3 = createFileRoute("/_authenticated/dashboard")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./calendar-BWSupvlI.mjs");
const Route$2 = createFileRoute("/_authenticated/calendar")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./academics-CKj1eBl3.mjs");
const Route$1 = createFileRoute("/_authenticated/academics")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./students._id-DcryhZiG.mjs");
